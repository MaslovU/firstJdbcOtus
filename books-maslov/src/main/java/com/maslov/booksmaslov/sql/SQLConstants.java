...
public class SQLConstants {
    ...
    public static final String UPDATE_BOOK_BY_ID = "update Book b set b.id=:id, b.name=:name, b.year_id=:year_id, b.genre_id=:genre_id where b.id=:id";
    ...
    public static final String UPDATE_AUTHORS_BY_ID = "update Author a set a.id=:id, a.author_name=:author_name, " +
            "where a.id=:id";
