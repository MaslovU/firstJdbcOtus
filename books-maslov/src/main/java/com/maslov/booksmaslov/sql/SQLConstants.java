...
public class SQLConstants {
    ...
    public static final String GET_ALL_BOOKS = "select id, name, author_id, year_of_publishing, genre_id from book";
    public static final String SELECT_BOOK_BY_ID = "select id, name, author_id, year_of_publishing, " +
            "genre_id from book where id =:id";
    public static final String SELECT_BOOK_BY_NAME = "select id, name, author_id, year_of_publishing, " +
            "genre_id from book where name =:name";
